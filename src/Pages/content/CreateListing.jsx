...
const CreateListing = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      {/* البطاقة البيضاء التي تبرز فوق الخلفية الرمادية */}
      <div className="bg-light-card dark:bg-dark-card rounded-xl shadow-lg border border-light-border dark:border-dark-border p-6 sm:p-8">
        <div className="flex items-center gap-4 mb-8">
          <BackButton />
          <h1 className="text-2xl font-bold text-light-text dark:text-dark-text">إضافة إعلان جديد</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <Input
            label="العنوان"
            name="title"
            placeholder="مثال: شقة للإيجار في وسط المدينة"
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-4 p-6 bg-light-bg dark:bg-dark-bg border-2 border-dashed border-light-border dark:border-dark-border rounded-lg">
              ...
              <label className="w-20 h-20 border-2 border-dashed border-accent-main/50 dark:border-accent-main/30 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-accent-main/5 dark:hover:bg-accent-main/10 transition-colors group bg-white dark:bg-dark-bg">
